    ...
    <>
      <div className="relative px-5 md:px-10 xl:px-15 2xl:px-30">
        ...
        <div className="relative min-h-[100vh] flex flex-col items-center justify-center">
          ...
          <div className="font-outfit w-full fixed px-5 lg:px-7 xl:px-10 2xl:px-15 top-0  py-5 z-[20000000] 2xl:px-25">
          ...
          <div className="w-full px-5 relative">
            ...
            <div className="flex relative z-[2000]">
              <div className="flex items-center justify-center top-0 absolute left-1/2 -translate-x-1/2 ">
                {/* absolute left-0 */}
                <img
                  className="w-[80px] h-[100px] sm:w-[100px] sm:h-[140px] xl:w-[120px] 2xl:w-[140px] 2xl:h-[180px] xl:h-[160px] sm:-ml-[20px]  object-cover object-left z-[200] rounded-lg transition-all rotate-0 hover:translate-y-[-20px] delay-[15ms]"
                ...
                />
                <img
                  className="w-[80px] h-[100px] sm:w-[100px] sm:h-[140px] xl:w-[120px] 2xl:w-[140px] 2xl:h-[180px] xl:h-[160px] sm:-ml-[20px] -ml-[30px] object-cover object-left hover:z-[200] z-[199] rounded-lg transition-all  hover:translate-y-[-20px] delay-[15ms] rotate-2"
                ...
                />
                <img
                  className="w-[80px] h-[100px] sm:w-[100px] sm:h-[140px] xl:w-[120px] 2xl:w-[140px] 2xl:h-[180px] xl:h-[160px] sm:-ml-[20px] -ml-[30px] object-cover object-left hover:z-[200] z-[198] rounded-lg transition-all  hover:translate-y-[-20px] delay-[15ms] rotate-2"
                ...
                />
                <img
                  className="w-[80px] h-[100px] sm:w-[100px] sm:h-[140px] xl:w-[120px] 2xl:w-[140px] 2xl:h-[180px] xl:h-[160px] sm:-ml-[20px] -ml-[30px] object-cover object-left hover:z-[200] z-[197] rounded-lg transition-all  hover:translate-y-[-20px] delay-[15ms] rotate-2"
                ...
                />
                <img
                  className="w-[80px] h-[100px] sm:w-[100px] sm:h-[140px] xl:w-[120px] 2xl:w-[140px] 2xl:h-[180px] xl:h-[160px] sm:-ml-[20px] -ml-[30px] object-cover object-left hover:z-[200] z-[196] rounded-lg transition-all  hover:translate-y-[-20px] delay-[15ms] rotate-2"
            ...
            <section className="flex flex-col font-BG items-center mt-28 sm:mt-38 xl:mt-43 2xl:mt-48 justify-center max-w-[550px] xl:max-w-[630px] mx-auto text-center relative">
              <h1 className="text-3xl sm:text-5xl xl:text-6xl">
                3D Printing Made Easier
              </h1>
              <p className="mt-2 text-[15px] sm:text-[17px] xl:text-lg">
                Bringing your ideas to life through custom 3D printing — from
                prototypes to personalized gear, made with precision and
                passion."
              </p>
              <div className="mt-3 flex gap-x-3 relative">
                <button className="bg-white px-3 py-1 rounded-lg cursor-pointer hover:bg-[hsl(0_0%_97%)] 2xl:px-4 2xl:py-1.5">
                  Contact
                </button>
                <button className="bg-orangish px-3 py-1 rounded-lg cursor-pointer hover:bg-orangish/60 text-white z-[200000] 2xl:px-4 2xl:py-1.5">
                  See More
                </button>
              </div>
              <img
